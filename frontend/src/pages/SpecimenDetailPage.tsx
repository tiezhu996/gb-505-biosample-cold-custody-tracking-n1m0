...
import { IncidentPeriods, OpenIncidentWarning } from '../components/common/IncidentPeriods'
...
export function SpecimenDetailPage() {
  ...
  return (
    <div className="page-stack">
      ...
      <OpenIncidentWarning specimen={specimen} />
      ...
      <section className="detail-section"><Typography.Title level={4}>温度异常时段</Typography.Title><IncidentPeriods items={specimen.incidentItems} /></section>
